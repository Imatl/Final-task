  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-4 gap-4">
        <StatCard title="Total Tickets" value={overview?.total_tickets || 0} icon={TrendingUp} color="#a855f7" />
        <StatCard title="Open Tickets" value={overview?.open_tickets || 0} icon={Clock} color="#22d3ee" />
        <StatCard
          title="Avg Resolve Time"
          value={overview ? `${overview.avg_resolve_time_minutes.toFixed(1)}m` : '0m'}
          icon={Zap}
          color="#e879f9"
        />
        <StatCard
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <Card className="p-5">
          <h3 className="text-sm font-medium text-gray-300 mb-4">By Priority</h3>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
        ...
        <Card className="p-5">
          <h3 className="text-sm font-medium text-gray-300 mb-4">By Sentiment</h3>
          <ResponsiveContainer width="100%" height={250}>
            <PieChart>
      ...
      {agents && agents.length > 0 && (
        <Card className="p-5">
          <h3 className="text-sm font-medium text-gray-300 mb-4">Agent Performance</h3>
            ...
            <tbody>
              {agents.map((a) => (
                <tr key={a.agent_id} className="border-b border-cosmic-700/30 last:border-0">
                  ...
                  <td className="py-3 text-gray-400">{a.avg_resolve_time_minutes.toFixed(1)}m</td>
                  <td className="py-3">
