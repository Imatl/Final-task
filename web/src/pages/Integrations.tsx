...
const RESPONSE_EXAMPLE = `{
  "ticket_id": "t-abc123",
  "message": "I see the double charge...",
  "actions": [{
    "type": "refund",
    "status": "executed",
    "confidence": 0.9
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isSelected
          ? 'bg-cosmic-800/80 border-neon-violet/50 scale-105'
    ...
    >
      ...
      <Badge variant={isSelected ? 'neon' : 'default'}>
        {isSelected ? t('integrations.active') : t('integrations.connect')}
      </Badge>
    </button>
  );
}
